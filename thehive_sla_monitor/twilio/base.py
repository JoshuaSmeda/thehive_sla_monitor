...
from thehive_sla_monitor.alerter import message_dict, message_list, seen_list
...
class Twilio():
    ...
    def send_sms(self, hive_alert, *args):
        ...
        seen_list.append(hive_alert['id'])
